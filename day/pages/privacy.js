                ...
                <div className="card bg-white my-12 p-5">
                  <div className="shadow-none">
                    ...
                    <p className="py-1 leading-normal text-slate-900 text-justify">
                      This privacy notice for KabHai.in (
                    ...
                    <div className="py-1 leading-normal text-slate-900 text-justify">
                      <ul className="ml-10">
                        <li className="list-disc">
                          Visit our website at
                          <Link
                            href="https://kabhai.in/"
                            as="https://kabhai.in/"
                          >
                            <span className="ml-1 cursor-pointer text-blue-700 hover:text-blue-800">
                              https://kabhai.in/
                            </span>
                          </Link>
                    ...
                    <p className="py-1 leading-normal text-slate-900 text-justify">
                      ...
                      us at cyberlaxai@gmail.com.
                    </p>
                    <hr></hr>
                    <br></br>
                    <h2 className="font-medium text-xl leading-10 text-slate-900">
                      1. WHAT INFORMATION DO WE COLLECT?
                    </h2>
                    <h2 className="font-medium text-lg leading-8 text-slate-800">
                      Personal information you disclose to us
                    </h2>
                    <div className="my-1">
                      <p className="mb-2 leading-normal text-slate-900 text-justify italic">
                        <span className="font-bold text-slate-600 mr-1">
                          In Short:
                        </span>
                    ...
                    <div className="my-1">
                      <p className="mb-2 leading-normal text-slate-900 text-justify">
                        <span className="font-bold text-slate-600 mr-1">
                    ...
                    <div className="my-1">
                      ...
                      <p className="mt-2 leading-normal text-slate-900 text-justify">
                      ...
                      <ul className="mt-2 ml-10">
                        <li className="list-disc leading-normal text-slate-900 text-justify">
                          <span className="font-bold text-slate-600 italic mr-1">
                            Log and Usage Data.
                          </span>
                      ...
                      <ul className="mt-2 ml-10">
                        <li className="list-disc leading-normal text-slate-900 text-justify">
                          ...
                          precise or imprecise. How much information we collect
                          depends on the type and settings of the device you use
                          to access the Services. For example, we may use GPS
                          and other technologies to collect geolocation data
                          that tells us your current location (based on your IP
                          address). You can opt out of allowing us to collect
                          this information either by refusing access to the
                    ...
                    <ul className="ml-10">
                      <li className="list-disc leading-normal text-slate-900 text-justify">
                        ...
                        or protect an individual&apos;s vital interest, such as
                        to prevent harm.
                      </li>
                    </ul>
                    {/*  */}
                    ...
                    <p className="mb-2 leading-normal text-slate-900 text-justify italic">
                      ...
                      it is necessary and we have a valid legal reason (i.e.,
                    ...
                    <h2 className="font-medium text-lg leading-8 text-slate-800 underline italic">
                    ...
                    <ul className="ml-10">
                      <li className="mt-2 list-disc leading-normal text-slate-900 text-justify">
                        <span className="font-bold text-slate-600 italic mr-1">
                          Consent.
                        </span>
                    ...
                    {/*  */}
                    {/*  */}
                    <h2 className="mt-2 font-medium text-lg leading-8 text-slate-800 underline italic">
                    ...
                    <p className="mb-2 leading-normal text-slate-900 text-justify italic">
                      ...
                      that you share with third parties that we may link to or
                      who advertise on our Services, but are not affiliated
                      with, our Services.
                    </p>
                    <p className="mb-2 leading-normal text-slate-900 text-justify italic">
                      ...
                      regarding any such third parties, and we will not be
                      ...
                      service, or application does not imply an endorsement by
                      us. We cannot guarantee the safety and privacy of data you
                      ...
                      other websites, services, or applications that may be
                      linked to or from the Services. You should review the
                      policies of such third parties and contact them directly
                    ...
                    <p className="mb-2 leading-normal text-slate-900 text-justify italic">
                      ...
                      keeping your personal information for longer than 0.
                    </p>
                    <p className="mb-2 leading-normal text-slate-900 text-justify italic">
                    ...
                    <p className="mb-2 leading-normal text-slate-900 text-justify italic">
                      ...
                      applicable, to data portability. In certain circumstances,
                      you may also have the right to object to the processing of
                    ...
                    <p className="mb-2 leading-normal text-slate-900 text-justify italic">
                      ...
                      rights, you may email us at cyberlaxai@gmail.com.
                    </p>
                    <hr></hr> <br></br>
                    <h2 className="font-medium text-xl leading-10 text-slate-900">
                    ...
                    <p className="mb-2 leading-normal text-slate-900 text-justify italic">
                      ...
                      publicly post on the Services. To request removal of such
                    ...
                    <p className="mb-2 leading-normal text-slate-900 text-justify italic">
                      ...
                      may email us at cyberlaxai@gmail.com
                    </p>
                    <p className="leading-normal text-slate-900 text-justify">
                      KabHai.in
                    </p>
